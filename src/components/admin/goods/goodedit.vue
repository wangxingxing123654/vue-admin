                    ...
                    <el-form-item label="所属类别" prop="category_id">
                        <el-select v-model="ruleForm.category_id " >
                            <el-option :label="item.title" :value="item.category_id" v-for="item in category">
                                ...
                                <span v-if="item.class_layer>1" v-for="i in (item.class_layer-1)">|-</span>
...
<script>
    ...
    export default {
        ...
        created(){this.getCategory();this.getOldData()},
        methods: {
            getOldData(){
                const id='/admin/goods/getgoodsmodel/'+this.$route.params.id;
            ...
            editData(){
//                /admin/goods/edit/:id
                const id='/admin/goods/edit/'+this.$route.params.id;
                console.log(id);
                this.$http.post(id,this.ruleForm).then(res=>{
                    if(res.data.status==1){
